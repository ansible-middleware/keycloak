...
options:
  ...
  provider_id:
    description:
      ...
      - The value V(rsa-enc) has been added in middleware_automation.keycloak 8.2.0.
      - The value V(java-keystore) has been added in middleware_automation.keycloak 12.4.0. This provider imports keys from
      ...
      - The values V(rsa-generated), V(hmac-generated), V(aes-generated), and V(ecdsa-generated) have been added in
        middleware_automation.keycloak 3.0.0. These are auto-generated key providers where Keycloak manages the key material.
      - The values V(rsa-enc-generated), V(ecdh-generated), and V(eddsa-generated) have been added in
        middleware_automation.keycloak 3.0.0. These correspond to the auto-generated key providers available in Keycloak 26.
    choices:
      - rsa
      - rsa-enc
      - java-keystore
      ...
      algorithm:
        description:
          ...
          - The values V(RS384), V(RS512), V(PS256), V(PS384), V(PS512), V(RSA1_5), V(RSA-OAEP), V(RSA-OAEP-256) have been
            added in middleware_automation.keycloak 8.2.0.
          - The values V(HS256), V(HS384), V(HS512) (for HMAC), V(ES256), V(ES384), V(ES512) (for ECDSA), and V(AES)
            have been added in middleware_automation.keycloak 12.4.0.
          - The values V(ECDH_ES), V(ECDH_ES_A128KW), V(ECDH_ES_A192KW), V(ECDH_ES_A256KW) (for ECDH key exchange),
            and V(Ed25519), V(Ed448) (for EdDSA signing) have been added in middleware_automation.keycloak 12.4.0.
